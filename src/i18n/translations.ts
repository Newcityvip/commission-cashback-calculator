export const translations = {
  bn: {
    ...
    heroTitle: 'হিসাব করুন সহজে ও নির্ভুলভাবে', heroText: 'ডিপোজিট ও উইথড্রয়ের পরিমাণ লিখুন। কমিশন ও ক্যাশব্যাক সঙ্গে সঙ্গে দেখুন।', instant: 'তাৎক্ষণিক হিসাব', noLogin: 'কোনো লগইন প্রয়োজন নেই', browserNote: 'ব্রাউজারেই হিসাব',
    ...
    deposit: 'ডিপোজিট', withdrawal: 'উইথড্র', depositAmount: 'ডিপোজিটের পরিমাণ', withdrawalAmount: 'উইথড্রয়ের পরিমাণ', depositCommission: 'ডিপোজিট কমিশন', withdrawalCommission: 'উইথড্র কমিশন', totalCommission: 'মোট কমিশন',
    ...
    reset: 'রিসেট', copy: 'ফলাফল কপি করুন', copied: 'কপি হয়েছে', enterValid: 'সঠিক শূন্য বা ধনাত্মক সংখ্যা লিখুন', notConfigured: 'এই ওয়ালেটের রেট এখনও নির্ধারিত হয়নি',
    footer: 'বাংলাদেশের এজেন্টদের জন্য সহজ, স্বচ্ছ হিসাব।', skip: 'মূল অংশে যান', language: 'ভাষা নির্বাচন', theme: 'থিম নির্বাচন', light: 'লাইট', dark: 'ডার্ক', inputHint: 'কমাসহ বা ছাড়া পরিমাণ লিখতে পারেন',
  },
  en: {
    appName: 'Hishab', tagline: 'Commission & Cashback Calculator', commission: 'Commission', cashback: 'Cashback', rates: 'Rates',
    heroTitle: 'Calculate Commission & Cashback', heroText: 'Enter your deposit and withdrawal amounts and instantly see your commission and cashback.', instant: 'Instant calculation', noLogin: 'No login required', browserNote: 'Calculated in your browser',
    ...
    reset: 'Reset', copy: 'Copy Result', copied: 'Copied', enterValid: 'Enter a valid zero or positive number', notConfigured: 'Rates for this wallet are not configured yet',
    footer: 'Simple, transparent calculations for Bangladesh agents.', skip: 'Skip to main content', language: 'Choose language', theme: 'Choose theme', light: 'Light', dark: 'Dark', inputHint: 'Enter amounts with or without commas',
  },
} as const
